...
**등록 방식 (현재)**:
- Seeking Signal 페이지 Style3 탭 → 벌크 입력 (`종목코드,종목명,매수날짜,매수가,매도날짜,매도가`)
- 파싱 후 개별/전체 "감시 등록" → `trade_watchlist` 저장 + Mode2 섹션 자동 생성 + watcher 등록
